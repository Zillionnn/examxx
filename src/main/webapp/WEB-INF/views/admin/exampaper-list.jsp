                ...
                <div class="page-content row">
                    ...
                    <div id="question-filter">
                        <dl id="question-filter-pagetype">
                            ...
                            <dd>
										<span data-id="2" id="shizhan" <c:if test="${papertype == '2' }">
                    ...
                    <div id="question-list">
                        <table class="table-striped table">
                            ...
                            <c:forEach items="${paper }" var="item">
                                <c:if test="${item.creator=='admin'}">
                                    <tr>
                                        <td>
                                            <input type="checkbox" value="${item.id }">
                                        </td>
                                        <td>${item.id }</td>
                                        <td><a href="admin/exampaper-preview/${item.id }" target="_blank" title="预览"
                                               class="td-paper-name">${item.name }</a></td>
...
<script> window.onload=function(){document.getElementById("shizhan").click(); }</script>