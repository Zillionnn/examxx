...
public class UserController {
    ...
    public
    @ResponseBody
    Message setting(@RequestBody User user) {
        Message message = new Message();
        try {
            userService.updateUser(user, null);
        } catch (Exception e) {
    ...
    public
    @ResponseBody
    Message disableUser(Model model, HttpServletRequest request, @PathVariable Integer userId) {
    ...
    public
    @ResponseBody
    Message enableUser(Model model, HttpServletRequest request, @PathVariable Integer userId) {
