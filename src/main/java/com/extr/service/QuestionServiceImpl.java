...
public class QuestionServiceImpl implements QuestionService {
	...
	/**
	 * 重载，整合了tag的功�?
	 * @see QuestionServiceImpl#updateQuestionPoint(Question question)
	 * @param question
	 * @param userId
	...
	public List<UserQuestionHistory> getUserQuestionHistory() {
		 List<UserQuestionHistory> uh=questionMapper.getUserQuestionHistory();
		 if(uh.size()!=0){
			 for(int i=0 ;i<uh.size();i++){
				 uh.get(i).setHistory(Object2Xml.toBean(uh.get(i).getHistoryStr(), Map.class));
			 }
		 }
		// TODO Auto-generated method stub
		return uh;
	...
	@Override
	public List<FalseQuestionResult> getFalseQuestionResult() {
		// TODO Auto-generated method stub
